...
random.seed(42)
topk_hard_neg_task_name = []
# 定义混合抽样策略
topk_hard_neg_task_name = ["visualnews_task0","webqa_task1","webqa_task2","visualnews_task3","oven_task6","oven_task8","fashioniq_task7"]
lastk_hard_neg_task_name =[]
randomk_neg_task_name = ["mscoco_task0","fashion200k_task0","edis_task2","mscoco_task3","fashion200k_task3","nights_task4","infoseek_task6","cirr_task7","infoseek_task8"]
datasetid2name = {
    0: 'visualnews', 1: 'fashion200k', 2: 'webqa', 3: 'edis', 
    4: 'nights', 5: 'oven', 6: 'infoseek', 7: 'fashioniq', 8: 'cirr', 9: 'mscoco'}
print(randomk_neg_task_name)
