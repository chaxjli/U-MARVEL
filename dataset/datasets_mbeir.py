...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(
        ...
        # 有时间可看一下这些数据加载完成都是什么格式 ！！！倒序进行训练
        self.query_data = _load_query_data(query_data_path) # [::-1] # [:1000] # 只加载一条数据用于测试
        ...
        # SOURCE_MODEL_NAME = "qwen2-vl-7b_BiLamRA_Ret_cc3m_llm_8m8g_4xlr_global_mixed_hard_neg_all_8m8g_1point5e-5"                           # 负样本的来源
        # RERANK_MODEL_NAME = "qwen2-vl-7b_BiLamRA_Ret_cc3m_llm_8m8g_4xlr-Rank-Only-Pointwise"   
        # HARD_NEGATIVE_PATH = f"./result/score/{RERANK_MODEL_NAME}/{SOURCE_MODEL_NAME}/local/fusion_results.jsonl"
        # self.testdata = _load_data(HARD_NEGATIVE_PATH)
    ...
    def get_instance(self, index):
        ...
        # query = _prepare_data_dict(query_txt_with_prompt, None, self.image_path_prefix)
