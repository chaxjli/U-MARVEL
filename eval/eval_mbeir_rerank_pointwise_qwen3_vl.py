...
def rerank(args):
    ...
    processor = AutoProcessor.from_pretrained(original_model_id,padding_side="left")
    ...
    assert processor.tokenizer.padding_side == "left", "Processor tokenizer padding_side must be left."
