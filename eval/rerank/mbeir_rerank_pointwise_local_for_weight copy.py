...
model_name = "qwen3-vl-4b_m-beir_stage1_model"                              # 这里需要修改: 需要第一阶段模型名称
rerank_model_name = "qwen3-vl-4b_m-beir_stage1_model"                   # 这里需要修改: 需要第二阶段 rerank 模型名称
task_names = [
...
# weight_params = [i*1.0 for i in range(0,21)]
weight_params = [0.1]
