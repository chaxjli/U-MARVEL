...
rerank_model_name = "qwen2-vl-7b_BiLamRA_Ret_cc3m_llm_8m8g_4xlr-Rank-Only-Pointwise_global"  # 这里需要修改: 需要第二阶段模型名称
task_names = [
    'visualnews_task0', 
...
k_lists = [1, 5, 10, 50]
rerank_path_prefix = f"./result/result_rank/temp/{rerank_model_name}/{model_name}/global/"
...
for weight_param in weight_params:
    ...
    for task_name in task_names:
        ...
        # result/result_eval_train/{model_name}/global/{task_name}_cand_names.json
        # result/result_rank/train/{rerank_model_name}/{model_name}/global/{task_name}_top50_train_queryid2rerank_score.json
        ...
        for idx, query_name in enumerate(query_names):
            ...
            raw_score = raw_scores[idx][50:100][::-1]
