...
def eval(args):
    ...
    rank0_print("""video_embeds = self.visual(pixel_values_videos, grid_thw=video_grid_thw).to(inputs_embeds.device) AttributeError: 'NoneType' object has no attribute 'device'""")
