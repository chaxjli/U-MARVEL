...
print(MODEL_NAME)
save_dir_name = f"./result/result_fast_sample/held-out/{MODEL_NAME}_eval_results_finetune/global"
if not os.path.exists(save_dir_name):
    os.makedirs(save_dir_name)
print("保存处理结果文件的目录: ",save_dir_name)
    
cand_feature_path_format = "./result/result_fast_sample/held-out/{}_eval_results_finetune/local/mbeir_{}_test_{}_candidate_features.pth"
cand_ids_path_format = "./result/result_fast_sample/held-out/{}_eval_results_finetune/local/mbeir_{}_test_{}_candidate_ids.json"


query_feature_path_format = "./result/result_fast_sample/held-out/{}_eval_results_finetune/local/mbeir_{}_test_{}_query_features.pth"
query_names_path_format = "./result/result_fast_sample/held-out/{}_eval_results_finetune/local/mbeir_{}_test_{}_query_names.json"
