...
cand_feature_path_format = "./result/{}_eval_results_finetune/local/mbeir_{}_test__candidate_features.pth"
cand_ids_path_format = "./result/{}_eval_results_finetune/local/mbeir_{}_test__candidate_ids.json"
query_feature_path_format = "./result/{}_eval_results_finetune/local/mbeir_{}_test__query_features.pth"
query_names_path_format = "./result/{}_eval_results_finetune/local/mbeir_{}_test__query_names.json"
