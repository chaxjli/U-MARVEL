...
query_data_paths = [
    ...
    "./data/M-BEIR/query/test/mbeir_visualnews_task0_test.jsonl",     # 4 机 0.4 h
    "./data/M-BEIR/query/test/mbeir_webqa_task2_test.jsonl",          # 4 机 0.3 h
    "./data/M-BEIR/query/test/mbeir_oven_task8_test.jsonl",           # 4 机 0.3 h
    "./data/M-BEIR/query/test/mbeir_infoseek_task8_test.jsonl",       # 4 机 0.5 h
    "./data/M-BEIR/query/test/mbeir_edis_task2_test.jsonl"            # 4 机 0.8 h
]
...
def eval(args):
    ...
    model = Qwen2_5_VLRetFinetuneForConditionalGeneration.from_pretrained(
        ...
        use_bi_atten=args.model_use_bi_atten == "True",
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size', type=int, default=32) # 根据显存调整 batch size=16 -> 32
