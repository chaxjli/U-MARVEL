...
register_model(
    ...
    model_hf_path="./checkpoints/hf_models/Qwen2_5-VL-7B-Instruct"
)

register_model(
    model_id="qwen3-vl-8b",
    model_family_id="qwen3-vl-8b",
    model_hf_path="./checkpoints/hf_models/Qwen3-VL-8B-Instruct"
)

register_model(
    model_id="qwen3-vl-4b",
    model_family_id="qwen3-vl-4b",
    model_hf_path="./checkpoints/hf_models/Qwen3-VL-4B-Instruct"
)
