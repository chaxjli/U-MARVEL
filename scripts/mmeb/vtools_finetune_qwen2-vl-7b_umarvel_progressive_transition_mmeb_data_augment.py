...
RUN_ID = f"{MODEL_ID}_umarvel_progressive_transition_mmeb_data_augment"
MODEL_LOCAL_PATH = "./checkpoints/qwen2-vl-7b_cc3m_llm-merged"  # 原始模型
QUERY_DATA_PATH = "./data/MMEB-train/mmeb_union_query_data_augment.jsonl"
...
torchrun_command = [
    ...
    *DISTRIBUTED_ARGS.split(),
    ...
    "--is_reset_max_pixels",str(IS_RESET_MAX_PIXELS),  # 是否重置最大像素值
