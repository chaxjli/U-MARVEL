...
RUN_ID = f"{MODEL_ID}_umarvel_hard_negative_mining_mmeb_8m8g_2lr" # 模型名称
SOURCE_MODEL_NAME = "qwen2-vl-7b_umarvel_progressive_transition_mmeb_8m8g_2lr"                                   # 负样本的来源
MODEL_LOCAL_PATH = "./checkpoints/mmeb/qwen2-vl-7b_umarvel_progressive_transition_mmeb_8m8g_2lr-merged"                       # 基座模型
...
# 负样本相关参数
HAS_HARD_NEGATIVE = True                             # 是否使用 hard negative
...
HARD_NEGATIVE_PATH = f"./result/mmeb/train/{SOURCE_MODEL_NAME}_eval_results_finetune/local/rerank_data_all_eval_train_local.jsonl"
MODALITY_HARD_NEGATIVE_PATH = f"./result/mmeb/train/{SOURCE_MODEL_NAME}_eval_results_finetune/global/rerank_data_all_eval_train_global.jsonl"
QUERY_FEATURE_PATH = f"./result/mmeb/train/{SOURCE_MODEL_NAME}_eval_results_finetune/global/all_query_names2query_features.pth" #  query 特征约束路径
CAND_FEATURE_PATH = f"./result/mmeb/train/{SOURCE_MODEL_NAME}_eval_results_finetune/global/all_cand_ids2cand_features.pth"      #  cand 特征约束路径
...
torchrun_command = [
    ...
    *DISTRIBUTED_ARGS.split(),
    "train/mmeb/train_mmeb_with_mixed_hard_neg_sample.py",
    "--model_id", MODEL_ID,
