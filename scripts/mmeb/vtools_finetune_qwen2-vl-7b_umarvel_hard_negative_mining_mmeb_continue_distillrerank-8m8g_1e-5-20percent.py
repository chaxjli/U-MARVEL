...
RUN_ID = f"{MODEL_ID}_umarvel_hard_negative_mining_mmeb_continue_distillrerank-8m8g_1e-5-20percent"     # 模型名称
...
QUERY_DATA_PATH = "./data/MMEB-train/mmeb_union_query_20percent.jsonl"
...
HARD_NEGATIVE_PATH = f"./result/score/mmeb/{RERANK_MODEL_NAME}/{SOURCE_MODEL_NAME}/local/20percent/fusion_results.jsonl"
MODALITY_HARD_NEGATIVE_PATH = f"./result/score/mmeb/{RERANK_MODEL_NAME}/{SOURCE_MODEL_NAME}/global/20percent/fusion_results.jsonl"
