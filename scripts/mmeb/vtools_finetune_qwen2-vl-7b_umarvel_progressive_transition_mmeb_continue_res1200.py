...
RUN_ID = f"{MODEL_ID}_umarvel_progressive_transition_mmeb_continue_res1200"  # 运行名称
MODEL_LOCAL_PATH = "./checkpoints/mmeb/qwen2-vl-7b_umarvel_progressive_transition_mmeb-merged"  # 原始模型
