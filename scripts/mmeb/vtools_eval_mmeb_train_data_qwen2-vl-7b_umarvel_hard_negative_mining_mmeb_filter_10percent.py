...
# 模型评估参数   -----  请根据实际情况修改
MODEL_NAME="qwen2-vl-7b_umarvel_hard_negative_mining_mmeb_filter"
...
# 创建结果目录
os.makedirs(f"./result/mmeb/train/{MODEL_NAME}_eval_results_finetune/local/10percent", exist_ok=True)
total_log_file = f"./result/mmeb/train/{MODEL_NAME}_eval_results_finetune/local/10percent/{TIMENAME}total_stdout.log"
...
command = [
    ...
    "train/mmeb/mmeb_get_rerank_train_data_from_eval_train_data_local_10percent.py",
    "--instructions_path=./data/MMEB-train/data_instruction.json",
    f"--save_dir_name=./result/mmeb/train/{MODEL_NAME}_eval_results_finetune/local/10percent",
