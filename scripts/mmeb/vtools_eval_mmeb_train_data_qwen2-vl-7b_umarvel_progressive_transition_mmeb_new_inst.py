...
# 模型评估参数   -----  请根据实际情况修改
MODEL_NAME="qwen2-vl-7b_umarvel_progressive_transition_mmeb_new_inst"
...
# 创建结果目录
os.makedirs(f"./result/mmeb/train/{MODEL_NAME}_eval_results_finetune/local/", exist_ok=True)
total_log_file = f"./result/mmeb/train/{MODEL_NAME}_eval_results_finetune/local/{TIMENAME}total_stdout.log"
...
command = [
    ...
    "train/mmeb/mmeb_get_rerank_train_data_from_eval_train_data_local.py",
    "--instructions_path=./data/MMEB-train/data_instruction_new.json",
    f"--save_dir_name=./result/mmeb/train/{MODEL_NAME}_eval_results_finetune/local",
