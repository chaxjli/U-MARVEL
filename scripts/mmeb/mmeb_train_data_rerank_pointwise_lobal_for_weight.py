...
for weight_param in weight_params:
    ...
    for task_name in task_names:
        ...
        raw_scores = load_json(f"./result/mmeb/train/{model_name}_eval_results_finetune/local/10percent/{task_name}_{model_name}_scores.json")
        rerank_scores = load_json(f"./result/result_rank/mmeb/train/{rerank_model_name}/{model_name}/local/10percent/{task_name}_top50_train_queryid2rerank_score.json")
        query_names = load_json(f"./result/mmeb/train/{model_name}_eval_results_finetune/local/10percent/{task_name}_{model_name}_query_names.json")
        cand_names = load_json(f"./result/mmeb/train/{model_name}_eval_results_finetune/local/10percent/{task_name}_{model_name}_cand_names.json")
