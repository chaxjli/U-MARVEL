...
RUN_ID = f"{MODEL_ID}_umarvel_progressive_transition_mmeb_only_nli"  # 模型名称
MODEL_LOCAL_PATH = "./checkpoints/BiLamRA_Ret_PretrainWithMeanpooling_Withoutprompt_token_cls-merged"  # 原始模型
