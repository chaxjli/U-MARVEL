...
os.makedirs(f"./result/result_rank/mmeb/train/{MODEL_NAME}/{SOURCE_MODEL_NAME}/local/10percent", exist_ok=True)
total_log_file = f"./result/result_rank/mmeb/train/{MODEL_NAME}/{SOURCE_MODEL_NAME}/local/10percent/{TIMENAME}total_stdout.log"
...
for i, TASK_NAME in enumerate(TASK_NAMES):
    ...
    check_file = f"./result/result_rank/mmeb/train/{MODEL_NAME}/{SOURCE_MODEL_NAME}/local/10percent/{TASK_NAME}_top50_train_queryid2rerank_score.json"
    print("====================================================================")
    ...
    if os.path.isfile(check_file):
        ...
        command = [
            ...
            f"--query_data_path=./data/MMEB-train/{TASK_NAME}/{TASK_NAME}_query_10percent.jsonl",
            ...
            f"--ret_query_data_path=./result/mmeb/train/{SOURCE_MODEL_NAME}_eval_results_finetune/local/10percent/{TASK_NAME}_{SOURCE_MODEL_NAME}_query_names.json",
            f"--ret_cand_data_path=./result/mmeb/train/{SOURCE_MODEL_NAME}_eval_results_finetune/local/10percent/{TASK_NAME}_{SOURCE_MODEL_NAME}_cand_names.json",
            f"--save_dir_name=./result/result_rank/mmeb/train/{MODEL_NAME}/{SOURCE_MODEL_NAME}/local/10percent",
            "--rank_num=50",
