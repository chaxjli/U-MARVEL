...
RUN_ID = f"{MODEL_ID}_umarvel_hard_negative_mining_mmeb_filter" # 模型名称
SOURCE_MODEL_NAME = "qwen2-vl-7b_umarvel_progressive_transition_mmeb"                                   # 负样本的来源
MODEL_LOCAL_PATH = "./checkpoints/mmeb/qwen2-vl-7b_umarvel_progressive_transition_mmeb-merged"                       # 基座模型
