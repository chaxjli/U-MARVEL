...
RUN_ID = f"{MODEL_ID}_umarvel_progressive_transition_mmeb"
...
# 创建结果目录
os.makedirs(f"./checkpoints/temp/mmeb/{RUN_ID}", exist_ok=True)
# 创建日志文件位置
log_file_path = f"./checkpoints/temp/mmeb/{RUN_ID}/{TIMENAME}stdout.log"
# 重定向标准输出到日志文件
...
torchrun_command = [
    ...
    *DISTRIBUTED_ARGS.split(),
    ...
    "--output_dir", f"./checkpoints/temp/mmeb/{RUN_ID}",
