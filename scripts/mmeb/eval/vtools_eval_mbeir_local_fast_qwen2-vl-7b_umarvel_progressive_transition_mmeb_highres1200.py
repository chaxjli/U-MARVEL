...
# 创建结果目录
os.makedirs(f"./result/mmeb/{MODEL_NAME}_eval_results_finetune/mmeb_cand_without_inst/highres1200", exist_ok=True)
total_log_file = f"./result/mmeb/{MODEL_NAME}_eval_results_finetune/mmeb_cand_without_inst/highres1200/{TIMENAME}total_stdout.log"
...
command = [
    ...
    f"--save_dir_name=./result/mmeb/{MODEL_NAME}_eval_results_finetune/mmeb_cand_without_inst/highres1200",
