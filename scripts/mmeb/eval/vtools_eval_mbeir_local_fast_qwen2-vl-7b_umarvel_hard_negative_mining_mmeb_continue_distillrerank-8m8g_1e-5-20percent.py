...
# 模型评估参数   -----  请根据实际情况修改
MODEL_NAME="qwen2-vl-7b_umarvel_hard_negative_mining_mmeb_continue_distillrerank-8m8g_1e-5-20percent"
...
# 创建结果目录
os.makedirs(f"./result/mmeb/{MODEL_NAME}_eval_results_finetune/mmeb_cand_without_inst", exist_ok=True)
total_log_file = f"./result/mmeb/{MODEL_NAME}_eval_results_finetune/mmeb_cand_without_inst/{TIMENAME}total_stdout.log"
...
command = [
    ...
    f"--save_dir_name=./result/mmeb/{MODEL_NAME}_eval_results_finetune/mmeb_cand_without_inst/",
