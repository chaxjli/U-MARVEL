...
# 创建结果目录
os.makedirs(f"./result/mmeb/{MODEL_NAME}_eval_results_finetune/mmeb_cand_without_inst/new_inst/", exist_ok=True)
total_log_file = f"./result/mmeb/{MODEL_NAME}_eval_results_finetune/mmeb_cand_without_inst/new_inst/{TIMENAME}total_stdout.log"
...
command = [
    ...
    "--instructions_path=./data/MMEB-eval/data_instruction_new.json",
    f"--save_dir_name=./result/mmeb/{MODEL_NAME}_eval_results_finetune/mmeb_cand_without_inst/new_inst",
