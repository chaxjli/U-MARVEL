...
os.environ["CUDA_VISIBLE_DEVICES"] = "2"  # 仅可见 NPU
...
# 模型评估参数   -----  请根据实际情况修改
MODEL_NAME="qwen2-vl-7b_umarvel_progressive_transition_mmeb_8m8g_3lr"
...
CURRENT_PORT = 29674
command = [
    # "CUDA_VISIBLE_DEVICES=2",  # 设置可见的 NPU 设备
    "accelerate",
    "launch",
    # "--multi_gpu",
    "--gpu_ids=2",  # 指定使用的 NPU ID
