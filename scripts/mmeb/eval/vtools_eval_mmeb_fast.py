...
# 创建结果目录
os.makedirs(f"./result/{MODEL_NAME}_eval_results_finetune/mmeb", exist_ok=True)
total_log_file = f"./result/{MODEL_NAME}_eval_results_finetune/mmeb/{TIMENAME}total_stdout.log"
