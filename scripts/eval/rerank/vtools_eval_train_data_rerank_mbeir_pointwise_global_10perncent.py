...
os.makedirs(f"./result/result_rank/train/{MODEL_NAME}/{SOURCE_MODEL_NAME}/global", exist_ok=True)
total_log_file = f"./result/result_rank/train/{MODEL_NAME}/{SOURCE_MODEL_NAME}/global/{TIMENAME}total_stdout.log"
...
for i, TASK_NAME in enumerate(TASK_NAMES):
    ...
    check_file = f"./result/result_rank/train/{MODEL_NAME}/{SOURCE_MODEL_NAME}/global/{TASK_NAME}_top50_train_queryid2rerank_score.json"
    print("====================================================================")
    ...
    if os.path.isfile(check_file):
        ...
        command = [
            ...
            f"--ret_query_data_path=./result/result_eval_train/{SOURCE_MODEL_NAME}/global/{TASK_NAME}_query_names.json",
            f"--ret_cand_data_path=./result/result_eval_train/{SOURCE_MODEL_NAME}/global/{TASK_NAME}_cand_names.json",
            f"--save_dir_name=./result/result_rank/train/{MODEL_NAME}/{SOURCE_MODEL_NAME}/global/",
            "--rank_num=50",
