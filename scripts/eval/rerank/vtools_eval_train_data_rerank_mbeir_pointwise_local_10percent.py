...
MODEL_NAME = "qwen2-vl-7b_umarvel_progressive_transition_m-beir-Rank-Only-Pointwise"                # 模型名称
MODEL_ID = f"./checkpoints/rerank_model/{MODEL_NAME}"                                               # rank 模型路径
# 第一阶段检索模型
SOURCE_MODEL_NAME = "qwen2-vl-7b_umarvel_hard_negative_mining" # 提供第一阶段检索结果的模型名称
...
for i, TASK_NAME in enumerate(TASK_NAMES):
    ...
    check_file = f"./result/result_rank/train/{MODEL_NAME}/{SOURCE_MODEL_NAME}/local/{TASK_NAME}_top50_train_queryid2rerank_score.json"
    print("====================================================================")
    ...
    if os.path.isfile(check_file):
        ...
        command = [
            ...
            "eval/eval_train_data_mbeir_rerank_pointwise.py",
            ...
            f"--ret_query_data_path=./result/result_eval_train/{SOURCE_MODEL_NAME}/local/mbeir_train_{TASK_NAME}_{SOURCE_MODEL_NAME}_query_names.json",
            f"--ret_cand_data_path=./result/result_eval_train/{SOURCE_MODEL_NAME}/local/mbeir_train_{TASK_NAME}_{SOURCE_MODEL_NAME}_cand_names.json",
