...
# 模型评估参数   -----  请根据实际情况修改
# MODEL_NAME="qwen3-vl-8b_m-beir_stage1_model_casual_atten_lr4e-4_bsz50_epoch1_lora32_alpha64_noresetmaxpixel"
# MODEL_NAME="qwen3-vl-8b_m-beir_stage1_model_casual_atten_lr4e-4_bsz50_epoch1_lora128_alpha256_noresetmaxpixel"
MODEL_NAME="qwen3-vl-8b_m-beir_stage1_model_casual_atten_lr2e-4_bsz50_epoch1_lora128_alpha256_noresetmaxpixel"
MODEL_ID = f"./checkpoints/{MODEL_NAME}"
ORIGINAL_MODEL_ID =f"./checkpoints/qwen3-vl-8b_cc3m_llm_stage1_model_casual_atten_lr1e-4_bsz60_epoch1_lora128_alpha256_2m8g-merged"  # 原始模型，用于加载权重
...
command = [
    ...
    "eval/eval_mbeir_local_finetune_fast_sample_qwen3_vl.py",
