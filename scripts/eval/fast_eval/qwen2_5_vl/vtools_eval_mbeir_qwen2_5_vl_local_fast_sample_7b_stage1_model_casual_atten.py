...
# 模型评估参数   -----  请根据实际情况修改
MODEL_NAME="qwen2_5-vl-7b_m-beir_stage1_model_casual_atten_lr4e-4_bs60_ep1_lora32_alpha64_noresetmaxpixel"
MODEL_ID = f"./checkpoints/{MODEL_NAME}"
ORIGINAL_MODEL_ID =f"./checkpoints/qwen2_5-vl-7b_cc3m_llm_stage1_model_casual_atten_lr2e-4_bsz60_epoch1_lorar32_alpha64_2m8g-merged"                                         # 原始模型，用于加载权重
