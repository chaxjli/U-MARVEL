...
MODEL_NAME="qwen2-vl-7b_BiLamRA_Ret_cc3m_llm_8m8g_4xlr_train_temperature_global_mixed_hard_neg_all_8m8g_1point5e-5-two_strategy_train_temperature_continue_distillrerank-8m8g_1e-5" # 温度参数的 2 阶段负样本模型继续蒸馏 local
...
#     --model_id $MODEL_ID \
#     --save_dir_name "./result/${MODEL_NAME}_eval_results_finetune/zeroshot/ccgenecis" \
...
#     --original_model_id $ORIGINAL_MODEL_ID \
#     --model_id $MODEL_ID \
#     --save_dir_name "./result/${MODEL_NAME}_eval_results_finetune/zeroshot/coco" \
#     --save_for_rerank > "./result/${MODEL_NAME}_eval_results_finetune/zeroshot/${CURRENT_TIME}_eval_coco.log"
...
# #     --original_model_id $ORIGINAL_MODEL_ID \
# #     --model_id $MODEL_ID \
# #     --save_dir_name "./result/${MODEL_NAME}_eval_results_finetune/zeroshot/vist" \
# #     --save_for_rerank > "./result/${MODEL_NAME}_eval_results_finetune/zeroshot/${CURRENT_TIME}_eval_vist.log"