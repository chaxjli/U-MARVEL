...
ORIGINAL_MODEL_IDS= [
            "qwen3-vl-4b_m-beir_stage2_model-merged",
            ]

MODEL_NAMES = [
            "qwen3-vl-4b_m-beir_stage3_model",
    ]

MODEL_IDS = [f"./checkpoints/{model_name}" for model_name in MODEL_NAMES]
ORIGINAL_MODEL_IDS = [f"./checkpoints/{original_model_id}" for original_model_id in ORIGINAL_MODEL_IDS]
