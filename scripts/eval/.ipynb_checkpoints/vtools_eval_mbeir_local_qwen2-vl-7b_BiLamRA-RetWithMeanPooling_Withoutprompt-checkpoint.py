...
# print(os.environ)
# # 设置分布式环境变量 ----- 提交 vtools 时注销，单机测试时不注销
...
MODEL_NAME="qwen2-vl-7b_BiLamRA-RetWithMeanPooling_Withoutprompt"
...
for i in range(len(query_data_paths)):
    ...
    if os.path.isfile(check_file):
        ...
        command = [
            ...
            "--num_processes=16",
            # "eval/eval_mbeir_local_multi_nodes.py",
            ...
            f"--save_dir_name=./result/temp/{MODEL_NAME}_eval_results",  # 不需要带 local 因为后续的 global 也会写入这个目录
