...
RUN_ID = f"{MODEL_ID}_m-beir_stage1_model_lr4e-4_bs60_ep1_lora32_alpha128_noresetmaxpixel"
# RUN_ID = f"{MODEL_ID}_m-beir_stage1_model_lr4e-4_bs60_ep1_lora128_alpha256_noresetmaxpixel_new_cc3m"
# MODEL_LOCAL_PATH = "./checkpoints/hf_models/Qwen2_5-VL-7B-Instruct"               # 原始模型
MODEL_LOCAL_PATH = "./checkpoints/qwen2_5-vl-7b_cc3m_llm_stage1_model-merged"     # 原始模型
# MODEL_LOCAL_PATH = "./checkpoints/qwen2_5-vl-7b_cc3m_llm_stage1_model_lr4e-4_bsz60_epoch1_lorar32_alpha64_2m8g-merged"     # 原始模型
...
# 定义训练参数
# 原始参数 lr=4e-4 bs=60 ep=1 lora_r=128 lora_alpha=256 IS_RESET_MAX_PIXELS=True
...
torchrun_command = [
    ...
    *DISTRIBUTED_ARGS.split(),
    "train/train_mbeir_qwen2_5_vl.py",
    "--model_id", MODEL_ID,
