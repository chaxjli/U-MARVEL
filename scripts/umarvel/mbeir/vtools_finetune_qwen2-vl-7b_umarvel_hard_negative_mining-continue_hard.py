...
RUN_ID = f"{MODEL_ID}_umarvel_hard_negative_mining-continue_hard"                       # 模型名称
RERANK_MODEL_NAME = "qwen2-vl-7b_umarvel_progressive_transition_m-beir-Rank-Only-Pointwise"
SOURCE_MODEL_NAME = "qwen2-vl-7b_umarvel_hard_negative_mining"                          # 负样本的来源
MODEL_LOCAL_PATH = "./checkpoints/qwen2-vl-7b_umarvel_hard_negative_mining-merged"      # 基座模型
...
MODEL_TOPK_HARD_NEGATIVE = 50
MODEL_TOPK_MODALITY_HARD_NEGATIVE = 50
...
MODEL_IGNORE_BATCH_OTHER_SAMPLES = True              # 是否忽略批次中的其他样本
...
torchrun_command = [
    ...
    *DISTRIBUTED_ARGS.split(),
    "train/train_mbeir_with_hard_neg_version2.py",
    "--model_id", MODEL_ID,
