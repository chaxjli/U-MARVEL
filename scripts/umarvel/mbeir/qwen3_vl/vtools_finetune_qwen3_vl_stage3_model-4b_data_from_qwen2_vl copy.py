...
HARD_NEGATIVE_PATH = f"./result/score/{RERANK_MODEL_NAME}/{SOURCE_MODEL_NAME}/local/fusion_results.jsonl"
MODALITY_HARD_NEGATIVE_PATH = f"./result/score/{RERANK_MODEL_NAME}/{SOURCE_MODEL_NAME}/global/fusion_results.jsonl"
