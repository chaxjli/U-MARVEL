...
RUN_ID = f"{MODEL_ID}_m-beir_stage3_model_skip_stage2_data_from_stage1"                             # 模型名称
...
SOURCE_MODEL_NAME = "qwen3-vl-4b_m-beir_stage1_model"                                       # 负样本的来源
RERANK_MODEL_NAME = "qwen3-vl-4b_m-beir_stage1_model-Rank-Only-Pointwise"                   # rerank 模型名称                         
MODEL_LOCAL_PATH = "./checkpoints/qwen3-vl-4b_m-beir_stage1_model-merged"                   # 基座模型
...
QUERY_FEATURE_PATH = f"./result/result_eval_train/{SOURCE_MODEL_NAME}/global/all_query_names2query_features.pth" #  query 特征约束路径
CAND_FEATURE_PATH = f"./result/result_eval_train/{SOURCE_MODEL_NAME}/global/all_cand_ids2cand_features.pth"      #  cand 特征约束路径
...
PER_DEVICE_BATCH_SIZE = 3                   # 实验的时候记得修改成 2 ，保持 140 的特征数量
GRAD_ACCUM = 1
NUM_EPOCHS = 1
LR = 1.0e-5
MODEL_MAX_LEN = 1024
