...
# 这个是历史的训练数据路径
# result/score/
# qwen2-vl-7b_BiLamRA_Ret_cc3m_llm_8m8g_4xlr-Rank-Only-Pointwise/
# qwen2-vl-7b_BiLamRA_Ret_cc3m_llm_8m8g_4xlr_train_temperature_global_mixed_hard_neg_all_8m8g_1point5e-5-two_strategy_train_temperature
# 定义参数
MODEL_ID = "qwen3-vl-4b"
RUN_ID = f"{MODEL_ID}_m-beir_stage3_model_data_from_stage2_using_qwen2_vl_rerank"                             # 模型名称
# SOURCE_MODEL_NAME = "qwen2-vl-7b_BiLamRA_Ret_cc3m_llm_8m8g_4xlr_train_temperature_global_mixed_hard_neg_all_8m8g_1point5e-5-two_strategy_train_temperature"# 负样本的来源
RERANK_MODEL_NAME = "qwen2-vl-7b_BiLamRA_Ret_cc3m_llm_8m8g_4xlr-Rank-Only-Pointwise"          # rerank 模型名称            
SOURCE_MODEL_NAME = "qwen3-vl-4b_m-beir_stage2_model"                                         # 负样本的来源
# RERANK_MODEL_NAME = "qwen3-vl-4b_m-beir_stage1_model-Rank-Only-Pointwise"                   # rerank 模型名称                         
MODEL_LOCAL_PATH = "./checkpoints/qwen3-vl-4b_m-beir_stage2_model-merged"                     # 基座模型
QUERY_DATA_PATH = "./data/M-BEIR/query/union_train/mbeir_union_up_train_10percent.jsonl"
...
HARD_NEGATIVE_PATH = f"./result/score/{RERANK_MODEL_NAME}/{SOURCE_MODEL_NAME}/local/10percent/fusion_results.jsonl"
MODALITY_HARD_NEGATIVE_PATH = f"./result/score/{RERANK_MODEL_NAME}/{SOURCE_MODEL_NAME}/global/10percent/fusion_results.jsonl"
QUERY_FEATURE_PATH = f"./result/result_eval_train/{SOURCE_MODEL_NAME}/global/10percent/all_query_names2query_features.pth" #  query 特征约束路径
CAND_FEATURE_PATH = f"./result/result_eval_train/{SOURCE_MODEL_NAME}/global/10percent/all_cand_ids2cand_features.pth"      #  cand 特征约束路径
...
PER_DEVICE_BATCH_SIZE = 3                   # 实验的时候记得修改成 3 ，保持 140 的特征数量
GRAD_ACCUM = 1
NUM_EPOCHS = 1
LR = 1.0e-5
MODEL_MAX_LEN = 1024
IS_RESET_MAX_PIXELS = True  # 是否重置最大像素值
# MAX_PIXEL = 200             # 重置的最大像素值
...
torchrun_command = [
    ...
    *DISTRIBUTED_ARGS.split(),
    "train/train_mbeir_with_distillrerank_qwen3_vl.py",
    "--model_id", MODEL_ID,
