...
RUN_ID = f"{MODEL_ID}_m-beir_stage1_model_lr2e-4_lora32_alpha64_noresetmaxpixel"
# MODEL_LOCAL_PATH = "./checkpoints/hf_models/Qwen3-VL-8B-Instruct"             # 原始模型
MODEL_LOCAL_PATH = "./checkpoints/qwen3-vl-8b_cc3m_llm_stage1_model-merged"     # 原始模型
...
# 定义训练参数
# 原始的学习率是 4e-4，LORA_R=128，LORA_ALPHA=256
