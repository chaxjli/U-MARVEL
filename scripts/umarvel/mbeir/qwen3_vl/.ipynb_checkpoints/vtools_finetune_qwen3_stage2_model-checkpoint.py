...
RUN_ID = f"{MODEL_ID}_m-beir_stage2_model_no_filter_false_hard_neg"                             # 模型名称
...
PER_DEVICE_BATCH_SIZE = 10                  # 实验的时候记得修改成 14，保持 50*2=100 的特征数量; 14跑的时候失败了改成12试试
GRAD_ACCUM = 1
NUM_EPOCHS = 1
LR = 1.5e-5
MODEL_MAX_LEN = 1024
IS_RESET_MAX_PIXELS = True                         # 是否重置最大像素值
MAX_PIXEL = 224                                  # 重置的最大像素值
