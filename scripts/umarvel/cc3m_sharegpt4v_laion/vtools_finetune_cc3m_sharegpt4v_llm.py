...
# os.environ['NPROC_PER_NODE'] = '8' # 单机单卡 debug 训练时设置为 8，单机单卡训练时设置为 1
...
RUN_ID = f"{MODEL_ID}_cc3m_sharegpt4v_llm"
DATA_PATH = "./data/cc3m-595k/train_anno.json"                                          # 训练数据集路径
DATA_PATH_2 = "/group/40077/chaxjli/Retrieve/LamRA/data/ShareGPT4V/sharegpt4v_256.json" # 训练集合路径
...
torchrun_command = [
    ...
    *DISTRIBUTED_ARGS.split(),
    "train/train_cc3m_sharegpt4v.py",
    "--model_id", MODEL_ID,
    "--data_path", DATA_PATH,
