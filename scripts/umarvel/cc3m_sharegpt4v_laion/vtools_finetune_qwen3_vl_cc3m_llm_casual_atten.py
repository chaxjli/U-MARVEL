...
MODEL_LOCAL_PATH = "./checkpoints/qwen3-vl-8b_nli_pertrain_stage1_model_casual_atten-merged"
RUN_ID = f"{MODEL_ID}_cc3m_llm_stage1_model_casual_atten_lr1e-4_bsz60_epoch1_lora128_alpha256_2m8g"
...
# 原来的参数数 lora_r=128 lora_alpha=256 lr=1e-4 bsz=60 epoch=1
