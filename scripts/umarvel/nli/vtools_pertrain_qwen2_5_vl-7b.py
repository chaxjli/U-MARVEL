...
RUN_ID = f"{MODEL_ID}_nli_pertrain_stage1_model_lr2e-4_bsz120_epoch2_lorar32_alpha64"
EVAL_DATA_PATH = None
...
# 原始的参数是 lora_r=64, lora_alpha=128,lr=2e-4, batch_size=72, epoch=2
