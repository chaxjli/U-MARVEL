...
# 定义参数
model_name = "qwen2-vl-7b_umarvel_hard_negative_mining"  # 模型名称
path_prefix = f"./result/result_eval_train/{model_name}/local"
if not os.path.exists(path_prefix):
    os.makedirs(path_prefix)
# 运行命令
command = [
    "python",
    "train/mbeir_merge_rerank_train_data_from_eval_train_10percent_data.py",
    "--path_prefix",
    path_prefix,
]
