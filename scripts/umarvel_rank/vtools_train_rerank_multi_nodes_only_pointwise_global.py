...
FIRST_MODEL_NAME = "qwen2-vl-7b_BiLamRA_Ret_cc3m_llm_8m8g_4xlr"
RUN_ID = f"{FIRST_MODEL_NAME}-Rank-Only-Pointwise_global"
...
RERANK_DATA_PATH = f"./result/result_eval_train/{FIRST_MODEL_NAME}/global/rerank_data_all_eval_train_global.json"
...
# 创建结果目录
os.makedirs(f"./checkpoints/rerank_model/{RUN_ID}", exist_ok=True)
total_log_file = f"./checkpoints/rerank_model/{RUN_ID}/{TIMENAME}total_stdout.log"
...
train_command = [
    ...
    *DISTRIBUTED_ARGS.split(),
    "train/train_rerank_multi_nodes_only_pointwise.py",
    "--model_id", MODEL_ID,
    "--query_data_path", QUERY_DATA_PATH,
    "--cand_pool_path", CAND_POOL_PATH,
    "--instructions_path", INSTRUCTIONS_PATH,
    "--output_dir", f"./checkpoints/rerank_model/{RUN_ID}",
