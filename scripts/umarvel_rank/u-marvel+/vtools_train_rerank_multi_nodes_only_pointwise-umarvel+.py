...
FIRST_MODEL_NAME = "qwen2-vl-7b_umarvel_distillation"
RUN_ID = f"{FIRST_MODEL_NAME}-umarvel+"
...
RERANK_DATA_PATH = f"./result/result_eval_train/{FIRST_MODEL_NAME}/local/rerank_data_all_eval_train_local.json"
