...
# 模型评估参数   -----  请根据实际情况修改
MODEL_NAME="qwen2-vl-7b_umarvel_hard_negative_mining"
MODEL_ID = f"./checkpoints/{MODEL_NAME}"
ORIGINAL_MODEL_ID ="./checkpoints/qwen2-vl-7b_umarvel_progressive_transition_m-beir-merged"
...
command = [
    ...
    "train/mbeir_get_rerank_train_data_from_eval_train_10percent_data_local.py",
