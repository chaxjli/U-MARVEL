...
RUN_ID = f"{FIRST_MODEL_NAME}-Rank"
...
RERANK_DATA_PATH = f"./result/result_eval_train/{FIRST_MODEL_NAME}/local/rerank_data_all_eval_train_local_withoutscore.json"
...
train_command = [
    ...
    *DISTRIBUTED_ARGS.split(),
    "train/train_rerank_multi_nodes.py",
    "--model_id", MODEL_ID,
