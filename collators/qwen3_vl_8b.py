...
from .qwen3_vision_process import process_vision_info,set_max_pixels
# from qwen_vl_utils import process_vision_info
# from .qwen3_vision_process import set_max_pixels


@register_collator("qwen3-vl-8b")
class Qwen3VL8BDataCollator(BaseDataCollator):
    def __init__(self,tokenizer, processor,has_instruction,use_instruction_token, \
        ...
        if self.is_reset_max_pixels and max_pixel is not None:
            ...
            # set_max_pixels(256*256)      # qwen3 vl 8b 使用更大的图片尺寸训练
