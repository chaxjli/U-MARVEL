...
@register_collator("qwen3-vl-4b")
class Qwen3VL4BDataCollator(BaseDataCollator):
    def __init__(self,tokenizer, processor,has_instruction,use_instruction_token, \
        ...
        if self.is_reset_max_pixels and max_pixel is not None:
            rank0_print("Warning: is_reset_max_pixels 为 True 时，max_pixel 参数将被忽略")
            ...
            # set_max_pixels(256*256)      # qwen3 vl 图片尺寸训练
