...
from dataset.datasets_mmeb import LazySupervisedDataset
...
def train():
    ...
    data_collator = COLLATORS[model_args.model_family_id](
        ...
        is_reset_max_pixels= data_args.is_reset_max_pixels, # 是否重置最大像素值
        max_pixel = data_args.max_pixel if hasattr(data_args, 'max_pixel') and data_args.max_pixel is not None else None,
    )
