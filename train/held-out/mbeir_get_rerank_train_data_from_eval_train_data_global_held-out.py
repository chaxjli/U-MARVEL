...
print(MODEL_NAME)
save_dir_name = f"./result/result_eval_train/held-out/{MODEL_NAME}/global"
...
cand_feature_path_format = "./result/result_eval_train/held-out/{}/local/mbeir_train_{}_{}_candidate_features.pth"
cand_ids_path_format = "./result/result_eval_train/held-out/{}/local/mbeir_train_{}_{}_candidate_ids.json"
query_feature_path_format = "./result/result_eval_train/held-out/{}/local/mbeir_train_{}_{}_query_features.pth"
query_names_path_format = "./result/result_eval_train/held-out/{}/local/mbeir_train_{}_{}_query_names.json"
...
task_names = [
    ...
    # 'nights_task4', 'oven_task6', 'infoseek_task6', 
