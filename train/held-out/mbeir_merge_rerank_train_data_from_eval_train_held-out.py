...
def merge_json_files(args):
    ...
    """
    # path_prefix: ./result/result_eval_train/held-out/qwen2-vl-7b_BiLamRA_Ret_cc3m_llm_8m8g_4xlr/local
    ...
    union_up_train_path = "/group/40077/Retrieval_Dataset/M-BEIR/query/union_train/mbeir_union_up_train_held-out.jsonl"
    ...
    print("rerank_all_data 个数应该是 544662, 实际是: ", len(rerank_all_data))
    ...
    print("data_query_with_top100_score 个数应该是 693190, 实际是: ", len(data_query_with_top100_score))
    ...
    print("all_data_with_scores 个数应该是 544662, 实际是: ", len(all_data_with_scores))
    if "local" in path_prefix:
