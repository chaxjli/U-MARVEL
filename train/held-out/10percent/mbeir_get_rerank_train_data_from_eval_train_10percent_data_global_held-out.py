...
print(MODEL_NAME)
save_dir_name = f"./result/result_eval_train/held-out/10percent/{MODEL_NAME}/global"
if not os.path.exists(save_dir_name):
    os.makedirs(save_dir_name)
print("保存处理结果文件的目录: ",save_dir_name)
# mbeir_train_cirr_task7_qwen2-vl-7b_BiLamRA_Ret_cc3m_llm_8m8g_4xlr_candidate_features.pth
cand_feature_path_format = "./result/result_eval_train/held-out/10percent/{}/local/mbeir_train_{}_{}_candidate_features.pth"
cand_ids_path_format = "./result/result_eval_train/held-out/10percent/{}/local/mbeir_train_{}_{}_candidate_ids.json"
query_feature_path_format = "./result/result_eval_train/held-out/10percent/{}/local/mbeir_train_{}_{}_query_features.pth"
query_names_path_format = "./result/result_eval_train/held-out/10percent/{}/local/mbeir_train_{}_{}_query_names.json"
...
task_names = [
    ...
    'webqa_task2', 'visualnews_task3', 'mscoco_task3', 'fashion200k_task3', 
    # 'nights_task4', 
    # 'oven_task6', 'infoseek_task6', 
    'fashioniq_task7', 'cirr_task7', 
    # 'oven_task8', 'infoseek_task8'
    ]
...
for task_name in task_names:
    ...
    # 保存 global 结果，用于训练 re-rank 模型 -------------------------------------------------------------------------------
    # 这里的 retrieval_res 是一个字典，包含了每个查询的相关文档和前 100 个检索到的文档
    with open(f"{save_dir_name}/{task_name}_global_data.json", 'w') as f:
