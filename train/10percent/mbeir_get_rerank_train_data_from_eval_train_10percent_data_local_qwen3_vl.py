...
# from models.qwen2_vl import Qwen3VLRetForConditionalGeneration # 作者的源代码,有问题吧，为什么拿这个模型评估
...
query_cand_pool_paths = [
    "./data/M-BEIR/cand_pool/global/mbeir_union_train_cand_pool.jsonl",
]
query_data_paths = [
    "./data/M-BEIR/query/train/query_train/mbeir_train_mscoco_task0_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_mscoco_task3_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_cirr_task7_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_fashioniq_task7_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_webqa_task1_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_nights_task4_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_oven_task6_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_infoseek_task6_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_fashion200k_task0_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_fashion200k_task3_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_visualnews_task3_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_visualnews_task0_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_webqa_task2_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_oven_task8_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_infoseek_task8_dedup_10percent.jsonl",
    "./data/M-BEIR/query/train/query_train/mbeir_train_edis_task2_dedup_10percent.jsonl",
]

cand_pool_paths = [
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_mscoco_task0_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_mscoco_task3_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_cirr_task7_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_fashioniq_task7_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_webqa_task1_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_nights_task4_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_oven_task6_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_infoseek_task6_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_fashion200k_task0_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_fashion200k_task3_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_visualnews_task3_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_visualnews_task0_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_webqa_task2_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_oven_task8_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_infoseek_task8_cand_pool.jsonl",
    "./data/M-BEIR/cand_pool/local/cand_train/mbeir_train_edis_task2_cand_pool.jsonl"
]

qrels_paths = [
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_mscoco_task0_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_mscoco_task3_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_cirr_task7_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_fashioniq_task7_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_webqa_task1_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_nights_task4_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_oven_task6_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_infoseek_task6_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_fashion200k_task0_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_fashion200k_task3_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_visualnews_task3_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_visualnews_task0_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_webqa_task2_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_oven_task8_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_infoseek_task8_qrels.txt",
    "./data/M-BEIR/qrels/train/qrels_train/mbeir_train_edis_task2_qrels.txt"
]
        ...
        while retry_count < max_retry_count:
            try:
                ...
                if is_main_process:
                    ...
                    retrieval_res = {}  # 保存 local 结果，用于训练 re-rank 模型
                    for ind, query_name in enumerate(tqdm(query_names)):
                        relevant_docs = qrel[query_name]
                        retrieved_indices_for_qid = cand_names[ind]
                        scores_for_qid = scores[ind]
                        # retrieval_res 是一个字典，key 是 query 的 did 
                        # value 是一个字典，gt_docs 是正样本的 did, top100_docs 是检索到的前 100 个 did
                        # scores 文件记录了 top100_docs 对应的 score,retrieved_indices_for_qid.tolist()
                    ...
                    # 保存 local 结果，用于训练 re-rank 模型 -------------------------------------------------------------------------------
                    # 这里的 retrieval_res 是一个字典，包含了每个查询的相关文档和前 100 个检索到的文档
                    with open(f"{save_dir_name}/{save_name}_local_data.json", 'w') as f:
                ...
                rank0_print(f"处理 {query_data_path} 时发生错误: {e}")
                retry_count += 1
                rank0_print(f"正在重试第 {retry_count} 次")
            if retry_count >= max_retry_count:
                rank0_print(f"重试次数超过最大限制，跳过该任务")
                rank0_print("*"*50)
                break
