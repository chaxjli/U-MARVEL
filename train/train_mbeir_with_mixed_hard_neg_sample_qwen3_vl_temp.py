...
from dataset.datasets_mbeir_with_mixed_hard_neg_sample_temp import LazySupervisedDataset  # 重要
...
def train():
    ...
    model, tokenizer, processor = loader.load(pretrain=False,hard_neg = True,use_bi_atten = model_args.use_bi_atten)
