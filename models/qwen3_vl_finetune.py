...
class Qwen3VLRetFinetuneForConditionalGeneration(BiQwen3VLForConditionalGeneration):
            ...
            if inputs_embeds is None:
                ...
                if pixel_values is not None:
                    ...
                    if current_image_num != 0:
                        ...
                        batch_image_embeds,batch_deepstack_image_embeds = self.visual(batch_pixel_values, grid_thw=image_grid_thw[image_nums:image_nums + current_image_num])
                ...
                if pixel_values_videos is not None:
                    ...
                    video_embeds, batch_deepstack_video_embeds= self.visual(pixel_values_videos, grid_thw=video_grid_thw)
